...
//
// 사용법: 브라우저 콘솔에서 loginDebug.enable() / loginDebug.disable()
// 또는 localStorage에 ad_debug_login=true 설정
//
// 로그 레벨:
...
function isEnabled(){
  try{return localStorage.getItem(DEBUG_KEY)==='true'}catch(e){return false}
}
...
var loginDebug={
  enable:function(){localStorage.setItem(DEBUG_KEY,'true');console.log('%c[LOGIN DEBUG] 활성화됨. 새로고침 후 적용.','color:#3fb950;font-weight:bold')},
